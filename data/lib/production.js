(function() {
  ...
  exports.NG_USERS = ['upmeetup', 'CheckNAU', '_____test', 'design_manabu', '_newsrss', 'RSS_hateb_Roy', 'SEtenshoku', 'appproject_kago', 'ayase_notice', 'iNewsEnta', 'web_hot_news', 'htbtr_js', 'postnewshatena', 'pctoolnews', 'hatebu777', 'hatena_news', 'RSS_hateb_l_Roy', 'JapanTechFeeds', 'slidebot', 'interest_web', 'wJSnews', 'swiftswiftjp', 'akio0911_news', 'KenichToudoh', 'hilbert_d', 'koziki33amatera', 'niigata_jyouhou', 'hatebu_android', 'koziki33tukuyom', 'app_news01', 'hounavi_android', 'kumechang'];
